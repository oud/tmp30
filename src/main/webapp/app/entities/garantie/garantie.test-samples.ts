...
export const sampleWithRequiredData: IGarantie = {
  ...
  dateAdhesionGarantie: dayjs('2025-07-22'),
  dateRadiationGarantie: dayjs('2025-07-21'),
  codeAssureur: 'the',
...
export const sampleWithFullData: IGarantie = {
  ...
  dateAdhesionGarantie: dayjs('2025-07-21'),
  dateRadiationGarantie: dayjs('2025-07-22'),
