...
export const sampleWithRequiredData: IPmEntreprise = {
  ...
  dateCreationJuridique: dayjs('2025-07-22'),
  dateEtat: dayjs('2025-07-21'),
  dateFermetureJuridique: dayjs('2025-07-22'),
  codeTrancheEffectif: 'gadzooks although muscat',
  libelleTrancheEffectif: 'trash plain',
  dateCessationActivite: dayjs('2025-07-22'),
  dateEffectifOfficiel: dayjs('2025-07-21'),
...
export const sampleWithPartialData: IPmEntreprise = {
  ...
  dateCreationJuridique: dayjs('2025-07-22'),
  dateEtat: dayjs('2025-07-22'),
  dateFermetureJuridique: dayjs('2025-07-21'),
  codeTrancheEffectif: 'shameless',
  libelleTrancheEffectif: 'maestro although',
  dateCessationActivite: dayjs('2025-07-21'),
  dateEffectifOfficiel: dayjs('2025-07-22'),
